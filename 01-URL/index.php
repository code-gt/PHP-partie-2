<?php
// EXERCICE 1
// Tester sur index.php que tous les paramètres de cette URL existent et les afficher : index.php?lastname=Nemare&firstname=Jean
?>
<h2>Exercice 1</h2>
...
echo '<br><br>';
// EXERCICE 2
// Tester sur index.php que le paramètre 'age' existe et si c'est le cas l'afficher sinon le signaler : index.php?lastname=Nemare&firstname=Jean
?>
<h2>Exercice 2</h2>
<form action="" method="">
    <input type="text" name="lastname" value="Nemare">
...
echo '<br><br>';
// EXERCICE 3
// Tester sur index.php que tous les paramètres de cette URL existent et les afficher : index.php?startDate=2/05/2016&endDate=27/11/2016
?>
<h2>Exercice 3</h2>
<form>
...
echo '<br><br>';
// EXERCICE 4
// Tester sur index.php que tous les paramètres de cette URL existent et les afficher : index.php?language=PHP&server=LAMP
?>
<h2>Exercice 4</h2>
<form>
...
<?php
// EXERCICE 5
// Tester sur index.php que le paramètre 'week' existe dans l'URL suivante : index.php?week=12
// Affichez la valeur de ce paramètre si elle existe.
?>
<h2>Exercice 5</h2>
<!-- À vous de faire le formulaire ici -->
...
// EXERCICE 6
// Tester sur index.php que les paramètres 'username' et 'userid' existent dans l'URL suivante : index.php?username=jdoe&userid=123
...
echo '<br><br>';
// EXERCICE 7
// Tester sur index.php que les paramètres 'number1' et 'number2' existent dans l'URL suivante : index.php?number1=10&number2=20
...
echo '<br><br>';
// EXERCICE 8
// Tester sur index.php que les paramètres 'item1', 'item2', et 'item3' existent dans l'URL suivante : index.php?item1=apple&item2=banana&item3=cherry
